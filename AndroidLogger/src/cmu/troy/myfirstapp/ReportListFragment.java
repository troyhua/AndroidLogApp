...
//import cmu.troy.myfirstapp.dummy.DummyContent;

/**
 * A list fragment representing a list of Reports. This fragment also supports tablet devices by
 * allowing list items to be given an 'activated' state upon selection. This helps indicate which
 * item is currently being viewed in a {@link ReportDetailFragment}.
 * <p>
...
public class ReportListFragment extends ListFragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setListAdapter(new ArrayAdapter<LogContent.LogItem>(getActivity(),
            android.R.layout.simple_list_item_activated_1, android.R.id.text1, LogContent.ITEMS));
  }
  ...
  public void onListItemClick(ListView listView, View view, int position, long id) {
    ...
    mCallbacks.onItemSelected(LogContent.ITEMS.get(position).id);
  }
